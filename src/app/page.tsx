...
const FALLBACK: MovieWithRating[] = [
  ...
  },
  {
    ...
    release_type: "OTT",
    ott_platform: "Prime Video",
    status: "published",
    genre: ["Sci-Fi", "Action", "Fantasy"],
    director: "Nag Ashwin",
    runtime_minutes: 181,
    summary:
      "Set in a dystopian future, a warrior rises to protect humanity. The most ambitious Indian sci-fi spectacle ever made.",
    ai_rating: 8.7,
    verdict: "Blockbuster",
    positive_sentiment: 78,
    neutral_sentiment: 14,
    negative_sentiment: 8,
    reactions_count: 18200,
    poster_url: null,
    backdrop_url: null,
    created_at: "",
    updated_at: "",
  },
  {
    ...
    runtime_minutes: 162,
    summary:
      "The extraordinary true story of Major Mukund Varadarajan, a film that will make you cry, salute and feel proud.",
    ai_rating: 9.0,
    verdict: "Blockbuster",
    positive_sentiment: 85,
    neutral_sentiment: 9,
    negative_sentiment: 6,
    reactions_count: 15800,
    poster_url: null,
    backdrop_url: null,
    created_at: "",
    updated_at: "",
  },
  {
    ...
    runtime_minutes: 133,
    summary:
      "The ghost is back but this time she has competition. Bollywood's biggest horror-comedy delivers laughs, scares, and heart.",
    ai_rating: 8.6,
    verdict: "Blockbuster",
    positive_sentiment: 82,
    neutral_sentiment: 11,
    negative_sentiment: 7,
    reactions_count: 22100,
    poster_url: null,
    backdrop_url: null,
    created_at: "",
    updated_at: "",
...
export default async function HomePage() {
  ...
  try {
    ...
    // Ignore language row fetch errors in development.
  }
  ...
  return (
    <>
      ...
      <div style={{ paddingTop: "70px" }}>
        <HeroSection movies={heroMovies as any} featuredMovies={top10 as any} />
      </div>
